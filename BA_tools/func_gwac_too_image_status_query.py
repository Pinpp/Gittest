...
def func_gwac_too_image_status_query(configuration_file,utc_datetime,datet_now_start,datet_now_end,mount_ra,mount_dec):
    ...
    DB_switch_datetime  = date_datetime + datetime.timedelta(hours=9)
    ...
    return datet_array,mount_ra_array,mount_dec_array,dpm_id_array,img_center_ra_array,img_center_dec_array,camera_id_array,camera_type_array,ff_id_array
